...
const zhCN: Record<string, string> = {
  ...
  "settings.palette.primary": "主色",
  "settings.palette.base": "底色",
  "settings.palette.modeNight": "夜间",
  ...
  "settings.palette.primary.indigo": "靛蓝",
  "settings.palette.primary.violet": "紫罗兰",
  "settings.palette.primary.graphite": "石墨",
  "settings.palette.primary.contrast": "高对比 AAA",
  "settings.palette.base.mist": "冷雾",
  "settings.palette.base.paper": "暖砂",
  "settings.palette.base.dune": "沙丘",
  "settings.palette.base.moss": "苔痕",
  "settings.palette.base.slate": "石板",
  "settings.palette.base.midnight": "夜蓝",
  "settings.palette.base.clay": "藕荷",
  "settings.palette.base.ink": "深墨",
  ...
  "settings.themePluginDescription":
    "选择已安装主题插件提供的主题，卸载对应插件后自动回退默认主题。",
  ...
  "settings.customSkin": "自定义皮肤",
  "settings.customSkinDescription": "选择图片作为应用背景，仅本机生效，不随账号同步。",
  "settings.customSkinSelect": "选择图片",
  "settings.customSkinReplace": "更换",
  "settings.customSkinClear": "清除",
  "settings.customSkin.applied": "自定义皮肤已更新",
  "settings.customSkin.errorNotImage": "所选文件不是图片或无法解码",
  "settings.customSkin.errorTooLarge": "图片过大，请换小图",
  "settings.customSkin.errorStorage": "本地存储空间不足，皮肤未保存",
  "settings.customSkinBlur": "背景模糊度",
  "settings.customSkinBlurDescription": "0 为最清晰，50 为最模糊。",
