...
const enUS: Record<string, string> = {
  ...
  "settings.palette.primary": "Primary color",
  "settings.palette.base": "Base color",
  "settings.palette.modeNight": "Night",
  ...
  "settings.palette.primary.indigo": "Indigo",
  "settings.palette.primary.violet": "Violet",
  "settings.palette.primary.graphite": "Graphite",
  "settings.palette.primary.contrast": "High-contrast AAA",
  "settings.palette.base.mist": "Cold Mist",
  "settings.palette.base.paper": "Warm Sand",
  "settings.palette.base.dune": "Dune",
  "settings.palette.base.moss": "Moss",
  "settings.palette.base.slate": "Slate",
  "settings.palette.base.midnight": "Night Blue",
  "settings.palette.base.clay": "Lotus",
  "settings.palette.base.ink": "Deep Ink",
  ...
  "settings.customSkin": "Custom skin",
  "settings.customSkinDescription":
    "Pick an image for the app background. It applies to this machine only and is not synced with your account.",
  "settings.customSkinSelect": "Choose image",
  "settings.customSkinReplace": "Replace",
  "settings.customSkinClear": "Clear",
  "settings.customSkin.applied": "Custom skin updated",
  "settings.customSkin.errorNotImage": "That file is not an image or could not be decoded",
  "settings.customSkin.errorTooLarge": "The image is too large; please choose a smaller one",
  "settings.customSkin.errorStorage": "Local storage is full; the skin was not saved",
  "settings.customSkinBlur": "Background blur",
  "settings.customSkinBlurDescription": "0 is the sharpest; 50 is the blurriest.",
